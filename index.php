...
<head>
    ...
    <title>News Website - Homepage</title>
    <style>
        ...
        .featured { background-color: white; margin: 20px; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1); }
        .featured h2 { color: #c00; }
...
<body>
    ...
    <section class="featured">
        ...
        <div class="news-grid">
            <?php
            include 'db.php';
            $sql = "SELECT * FROM news_articles ORDER BY publish_date DESC LIMIT 6";
    ...
    <script>
        // JS for redirection as per instructions
