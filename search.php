...
<head>
    ...
    <title>News Website - Search Results</title>
    <style>
        /* Internal CSS - Amazing, real-looking, responsive design (similar to others) */
        ...
        .search-results { background-color: white; margin: 20px; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1); }
        .search-results h2 { color: #c00; }
...
<body>
    ...
    <div class="search-bar">
        <form action="search.php" method="GET">
            <input type="text" name="query" placeholder="Search articles..." value="<?php echo isset($_GET['query']) ? htmlspecialchars($_GET['query']) : ''; ?>">
    ...
    <section class="search-results">
        ...
        <div class="news-grid">
            ...
            if ($query) {
                $sql = "SELECT * FROM news_articles WHERE title LIKE ? OR content LIKE ? ORDER BY publish_date DESC";
